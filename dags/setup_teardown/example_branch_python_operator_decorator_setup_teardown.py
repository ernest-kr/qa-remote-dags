...
with DAG(
    dag_id="example_branch_python_operator_decorator_setup_teardown",
    ...
    run_this_first >> random_choice_instance.as_setup()
    ...
    for option in options:
        ...
        random_choice_instance >> Label(option) >> t >> empty_follow >> join.as_teardown(setups=random_choice_instance)
