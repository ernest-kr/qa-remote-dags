...
start_date = pendulum.datetime(2021, 11, 25, tz=pendulum.timezone(chuuk))
...
with DAG(
    dag_id="scheduler_crash_with_date_args_v1",
    default_args=default_args,
    # pendulum start date, datetime future user defined macro
    start_date=start_date,
    schedule=None,
    catchup=False,
    user_defined_macros={"future_date": pytz.timezone("Etc/GMT-13").localize(datetime.datetime(2135, 11, 25))},
    tags=["core"],
) as dag:
    t1 = PythonOperator(
