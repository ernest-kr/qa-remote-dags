...
with DAG(
    dag_id="filesystem_sensor_glob_relative_path",
    ...
    t1 = FileSensor(
        task_id="sense_relative_files_1",
        fs_conn_id=conn_id,
        # it seems they fixed the bug where the filesensor wasn't using relative paths to the connection path
        filepath="*.py*",
        recursive=True,
        timeout=220,
        poke_interval=20,
        ...
        op_args=[
            {
                ...
                "sense_relative_files_1": TaskInstanceState.SUCCESS,
